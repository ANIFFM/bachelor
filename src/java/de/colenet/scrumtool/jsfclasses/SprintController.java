...
import de.colenet.scrumtool.sessionbeans.SprintFacade;
...
public class SprintController implements Serializable {
    ...
    @EJB
    private de.colenet.scrumtool.sessionbeans.SprintFacade ejbFacade;
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("SprintUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    public static class SprintControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Sprint) {
                ...
                return getStringKey(o.getSprintID());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Sprint.class.getName());
            }
        }
    }
}
